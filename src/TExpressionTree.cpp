...
//			throw MathError{ ErrorType::ERROR_I, std::string("sqrt(") + to_string(value1) + std::string("") };
//			return;
//		}
...
//			//恢复修改并抛出异常
//			Operator->eType = NODE_FUNCTION;
//			throw MathError{ ErrorType::ERROR_OUTOF_DOMAIN, std::string("tan(") + to_string(value) + std::string("") };
//			return;
//		}
...
//			//恢复修改并抛出异常
//			Operator->eType = NODE_FUNCTION;
//			throw MathError{ ErrorType::ERROR_OUTOF_DOMAIN, std::string("arcsin(") + to_string(value1) + std::string("") };
//			return;
//		}
...
//			//恢复修改并抛出异常
//			Operator->eType = NODE_FUNCTION;
//			throw MathError{ ErrorType::ERROR_OUTOF_DOMAIN, std::string("arccos(") + to_string(value1) + std::string("") };
//		}
...
//			//恢复修改并抛出异常
//			Operator->eType = NODE_FUNCTION;
//			throw MathError{ ErrorType::ERROR_OUTOF_DOMAIN, std::string("ln(") + to_string(value1) + std::string("") };
//		}
...
//			//恢复修改并抛出异常
//			Operator->eType = NODE_FUNCTION;
//			throw MathError{ ErrorType::ERROR_OUTOF_DOMAIN, std::string("log10(") + to_string(value1) + std::string("") };
//		}
...
//	case MATH_MOD://%
//		if ((int)value2 == 0)
//			throw MathError{ ErrorType::ERROR_DIVIDE_ZERO, to_string(value2) };
...
//		{
//			Operator->eType = NODE_OPERATOR;
//			throw MathError{ ErrorType::ERROR_I, std::string("pow(") + to_string(value1) + "," + to_string(value2) + "" };
//		}
